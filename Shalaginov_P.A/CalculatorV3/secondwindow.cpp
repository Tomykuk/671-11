...
void SecondWindow::digits_numbers()
{
...
void SecondWindow::on_pushButton_dot_clicked()
{
...
void SecondWindow::math_operations()
{
    QPushButton *button = (QPushButton *) sender();
...
void SecondWindow::on_pushButton_ravno_clicked()
{
    ...
    if(ui->pushButton_plus->isChecked()){
        ...
        if(num_second == 0) {
            ui->result_show->setText("don't can divide");
        }
...
{
    ui->result_show->setText("Потыкал? Вали!");
}
